                                        ...
                                        <div class="shipping-method-item">
                                            <label class="shipping-method-label" for="method-{{ $item->id }}">
                                                <div class="form-check">
                                                    <input onclick="handleGetCharge({{ $item->charge }})"  class="form-check-input" type="radio" name="shipping_method_id"
                        ...
                        <div class="checkout-card-body">
                            <div class="order-summary">
                                ...
                                <div class="summary-item">
                                   ...
                                   <span>৳ <span class="delivery-fee" id="delivery-fee">{{$shippingCharge}}</span>TK </span>
                                </div>
                                            ...
                                            <label class="payment-method-label" for="data-{{ $loop->index }}">
                                                <div class="form-check">
                                                    <input class="form-check-input online_payment" type="radio"
                                                        ...
                                                        id="data-{{ $loop->index }}" data-gateway="{{ $item }}"
                                                        >
