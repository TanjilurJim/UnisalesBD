                    ...
                    @foreach ($product->attributes as $attribute)
                        ...
                        <div class="attribute-value-wrapper attributeValueArea">
                            ...
                            @foreach ($attributeValues as $attributeValue)
                                ...
                                @endphp
                                <button class="attribute-value attributeBtn"
            ...
            <div class="d-flex gap-2 flex-column">
                ...
                <div class="product-wishlist d-flex gap-2 mt-3">
                    ...
                    @if (gs('product_wishlist'))
                        <button
                            class="add-to-wishlist-btn @if (checkWishList($product->id)) active @endif addToWishlist"
                            data-id="{{ $product->id }}">
                    ...
                    @if ($product->product_type_id && gs('product_compare'))
                        <button
                            class="add-to-wishlist-btn  @if (checkCompareList($product->id)) active @endif addToCompare"
                            data-id="{{ $product->id }}">
